...
class UltimateAutoTradingAI:
    ...
    def generate_auto_signal(self, price_action, indicators, current_price, pair):
        ...
        return {
            ...
            'is_high_confidence': final_confidence >= 60,  # Lowered from 80
            'all_signals': {
                'low': low_signal,
    ...
    def generate_high_confidence_signals(self, price_action, indicators):
        """ORIGINAL HIGH CONFIDENCE STRATEGY (80%+)"""
        ...
        return {
            ...
            'signals': [],
            'confidence_level': 'HIGH',
            'is_tradable': total_confidence >= 70  # Lowered from 80
        }
