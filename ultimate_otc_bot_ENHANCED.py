...
try:
    ...
    print("✅ USING ORIGINAL STRATEGIES (Enhanced ones failed)")
...
# Add logs module
try:
    from strategies.logs import setup_log_handlers
    LOGS_LOADED = True
...
def main():
    ...
    try:
        ...
        if LOGS_LOADED:
            setup_log_handlers(application)
            print("📊 Log commands: /logs")
